...
public class sendkeytester {

    private Robot robot;

  /*  public static void main(String... args) throws Exception {
    	sendkeytester sendkeytester = new sendkeytester();
    	sendkeytester.type("Hello there, how are you?");
    }*/
	public static void main(String[] args) throws Exception {
    ...
    public sendkeytester() throws AWTException {
    	this.robot = new Robot();
    }

    public sendkeytester(Robot robot) {
    	this.robot = robot;
    }
    ...
    private void doType(int[] keyCodes, int offset, int length) {
    	...
    	robot.delay(5);                  //Changes the speed it sends the keys (miliseconds)
